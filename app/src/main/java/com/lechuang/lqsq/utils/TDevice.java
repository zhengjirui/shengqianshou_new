...
public class TDevice {
    ...
    public static DisplayMetrics getDisplayMetrics() {
        ...
        ((WindowManager) MyApplication.getContext().getSystemService(
    ...
    public static boolean hasBigScreen() {
        ...
        if (_hasBigScreen == null) {
            boolean flag1;
            if ((0xf & MyApplication.getContext().getResources()
    ...
    public static final boolean hasCamera() {
        if (_hasCamera == null) {
            PackageManager pckMgr = MyApplication.getContext()
                    .getPackageManager();
            boolean flag = pckMgr
    ...
    public static boolean isPackageExist(String pckName) {
        try {
            PackageInfo pckInfo = MyApplication.getContext().getPackageManager()
    ...
    public static boolean isLandscape() {
        boolean flag;
        if (MyApplication.getContext().getResources().getConfiguration().orientation == 2)
            flag = true;
        else
            flag = false;
        return flag;
    ...
    public static String getCurCountryLan() {
        return MyApplication.getContext().getResources().getConfiguration().locale
                .getLanguage()
                + "-"
                + MyApplication.getContext().getResources().getConfiguration().locale
                .getCountry();
    }

    public static boolean isZhCN() {
        String lang = MyApplication.getContext().getResources()
    ...
    public static int getVersionCode() {
        ...
        try {
            versionCode = MyApplication
                    .getContext()
                    .getPackageManager()
                    .getPackageInfo(MyApplication.getContext().getPackageName(),
                            0).versionCode;
    ...
    public static String getIMEI() {
        TelephonyManager tel = (TelephonyManager) MyApplication.getContext()
    ...
    public static void openApp(Context context, String packageName) {
        Intent mainIntent = MyApplication.getContext().getPackageManager()
    ...
    public static int getStatuBarHeight() {
        ...
        try {
            ...
            field = c.getField("status_bar_height");
            x = Integer.parseInt(field.get(obj).toString());
            sbar = MyApplication.getContext().getResources()
                    .getDimensionPixelSize(x);
