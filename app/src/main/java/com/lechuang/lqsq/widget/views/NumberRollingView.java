        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case MONEY_TYPE://金额数字的滚动
                    ...
                    if (useCommaFormat) {
                        //使用每三位数字一个逗号格式的字符串
                        String formatStr = StringUtils.addComma(str, true);
                    ...
                    if (nowMoneyNum < finalMoneyNum) {
                        ...
                        //已经达到目标的金额数字，显示最终的数字
                        if (useCommaFormat) {
                            NumberRollingView.this.setText(isZhengshu(StringUtils.addComma(formatter.format(finalMoneyNum), true)));
                        } else {
                ...
                case NUM_TYPE://普通数字滚动
                    ...
                    if (useCommaFormat) {
                        //使用每三位数字一个逗号格式的字符串
                        String formatStr = StringUtils.addComma(String.valueOf(nowNum), false);
                        NumberRollingView.this.setText(formatStr);
                    } else {
                    ...
                    if (nowNum < finalNum) {
                        ...
                        //已经达到目标的数字，显示最终的内容
                        if (useCommaFormat) {
                            NumberRollingView.this.setText(isZhengshu(StringUtils.addComma(String.valueOf(finalNum), false)));
                        } else {
